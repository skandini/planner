...
export const TICKET_HISTORY_ENDPOINT = (ticketId: string) => `${API_BASE_URL}/tickets/${ticketId}/history`;
export const TICKET_INTERNAL_NOTES_ENDPOINT = (ticketId: string) => `${API_BASE_URL}/tickets/${ticketId}/internal-notes`;
export const TICKET_CATEGORIES_ENDPOINT = `${API_BASE_URL}/ticket-categories/`;
export const TICKET_STATISTICS_ENDPOINT = `${API_BASE_URL}/ticket-statistics/`;
export const TICKET_BULK_UPDATE_ENDPOINT = `${API_BASE_URL}/ticket-statistics/bulk-update`;
